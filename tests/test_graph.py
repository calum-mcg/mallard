        ...
        "tables": [
            {
                ...
                "dependencyTargets": [
                    {"database": "proj", "schema": "data", "name": "raw_orders"}
                ],
            },
            {
                "target": {"database": "proj", "schema": "data", "name": "fct_orders"},
                "dependencyTargets": [
                    {"database": "proj", "schema": "data", "name": "stg_orders"}
                ],
            },
        ],
        "declarations": [
    ...
    compiled_graph = {
        "tables": [
            ...
            },
            {
                ...
                "type": "table",
                "dependencyTargets": [
                    {"database": "my_proj", "schema": "data", "name": "stg_orders"}
                ],
            },
            {
                "target": {
                ...
                "type": "table",
                "dependencyTargets": [
                    {"database": "my_proj", "schema": "data", "name": "fct_orders"}
                ],
            },
        ]
    }
